...
Public Class BasicShape
    ...
    Private _Connector As AdvancedHMI.Controls_Net46.ConnecterType
    ...
    Private _Direction As AdvancedHMI.Controls_Net46.LineDirection
    ...
    Public Sub New()
        ...
        Me._Connector = AdvancedHMI.Controls_Net46.ConnecterType.Center
        ...
        Me.bool_2 = True
        Me._BlinkRate = 500
        Me._Direction = AdvancedHMI.Controls_Net46.LineDirection.None
            ...
            If (Me._BorderWidth > 0) Then
                Using pen As System.Drawing.Pen = New System.Drawing.Pen(Me.color_9, CSng((Me._BorderWidth * 2)))
                    If (If(Me.Shape = AdvancedHMI.Controls_Net46.ShapeType.LineDown OrElse Me.Shape = AdvancedHMI.Controls_Net46.ShapeType.LineUp OrElse Me.Shape = AdvancedHMI.Controls_Net46.ShapeType.LineHorizontal, True, Me.Shape = AdvancedHMI.Controls_Net46.ShapeType.LineVertical)) Then
                        ...
                        If (Me._Direction <> AdvancedHMI.Controls_Net46.LineDirection.None) Then
                            ...
                            If (CInt(shape) - CInt(AdvancedHMI.Controls_Net46.ShapeType.LineDown) > CInt(AdvancedHMI.Controls_Net46.ShapeType.Diamond)) Then
                                If (shape = AdvancedHMI.Controls_Net46.ShapeType.LineVertical) Then
                                    If (If(Me._Direction = AdvancedHMI.Controls_Net46.LineDirection.LeftUp, False, Me._Direction <> AdvancedHMI.Controls_Net46.LineDirection.RightUp)) Then
                                        pen.EndCap = LineCap.ArrowAnchor
                                    Else
                                        pen.StartCap = LineCap.ArrowAnchor
                                    End If
                                End If
                            ElseIf (If(Me._Direction = AdvancedHMI.Controls_Net46.LineDirection.LeftUp, False, Me._Direction <> AdvancedHMI.Controls_Net46.LineDirection.LeftDown)) Then
                                pen.EndCap = LineCap.ArrowAnchor
                            Else
                                pen.StartCap = LineCap.ArrowAnchor
                            End If
    ...
    Protected Overrides Sub OnResize(ByVal e As EventArgs)
        ...
        ElseIf (MyBase.Height >= 2 * Me._BorderWidth) Then
            ...
            If (Me.graphicsPath_1 IsNot Nothing) Then
                ...
                Else
                    Dim num As Integer = If(Me.Shape = AdvancedHMI.Controls_Net46.ShapeType.Rectangle, 1, Me._BorderWidth)
