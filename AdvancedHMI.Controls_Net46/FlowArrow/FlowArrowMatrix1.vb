...
Namespace FlowArrow
    Public Class FlowArrowMatrix1
        ...
        Private Sub FlowArrowMatrix1_Resize(ByVal sender As Object, ByVal e As EventArgs)
            If ((Me.arrowDirectionOption_0 = AdvancedHMI.Controls_Net46.FlowArrow.FlowArrowMatrix1.ArrowDirectionOption.Right) OrElse (Me.arrowDirectionOption_0 = AdvancedHMI.Controls_Net46.FlowArrow.FlowArrowMatrix1.ArrowDirectionOption.Left)) Then
        ...
        Public Property ArrowDirection As ArrowDirectionOption
            ...
            Set(ByVal value As ArrowDirectionOption)
                If (Me.arrowDirectionOption_0 <> value) Then
                    ...
                    If ((((Me.arrowDirectionOption_0 = AdvancedHMI.Controls_Net46.FlowArrow.FlowArrowMatrix1.ArrowDirectionOption.Right) OrElse (Me.arrowDirectionOption_0 = AdvancedHMI.Controls_Net46.FlowArrow.FlowArrowMatrix1.ArrowDirectionOption.Left)) AndAlso ((value <> ArrowDirectionOption.Right) AndAlso (value <> ArrowDirectionOption.Left))) OrElse (((Me.arrowDirectionOption_0 = AdvancedHMI.Controls_Net46.FlowArrow.FlowArrowMatrix1.ArrowDirectionOption.Up) OrElse (Me.arrowDirectionOption_0 = AdvancedHMI.Controls_Net46.FlowArrow.FlowArrowMatrix1.ArrowDirectionOption.Down)) AndAlso ((value <> ArrowDirectionOption.Up) AndAlso (value <> ArrowDirectionOption.Down)))) Then
