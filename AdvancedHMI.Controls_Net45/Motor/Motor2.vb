...
#End Region
    ...
    Public Sub New()
        ...
        tmrError = New Timer()
        SourceImageRatio = New Decimal(CDbl(My.Resources.Motor1_Red_Right.Height) / CDbl(My.Resources.Motor1_Red_Right.Width))
    ...
    Private Sub AdjustRatio()
        If Not (m_Rotation = RotateFlipType.Rotate90FlipNone Or m_Rotation = RotateFlipType.Rotate270FlipNone Or m_Rotation = RotateFlipType.Rotate90FlipX Or m_Rotation = RotateFlipType.Rotate270FlipX Or m_Rotation = RotateFlipType.Rotate270FlipX Or m_Rotation = RotateFlipType.Rotate90FlipX Or m_Rotation = RotateFlipType.Rotate270FlipNone Or m_Rotation = RotateFlipType.Rotate90FlipNone) Then
            SourceImageRatio = New Decimal(CDbl(My.Resources.Motor1_Red_Right.Height) / CDbl(My.Resources.Motor1_Red_Right.Width))
        Else
            SourceImageRatio = New Decimal(CDbl(My.Resources.Motor1_Red_Right.Width) / CDbl(My.Resources.Motor1_Red_Right.Height))
        End If
    ...
    Private Sub RefreshImage()
        ...
        If Not (Width <= 0 Or Height <= 0) Then
            If Not (m_Rotation = RotateFlipType.Rotate90FlipNone Or m_Rotation = RotateFlipType.Rotate270FlipNone Or m_Rotation = RotateFlipType.Rotate90FlipX Or m_Rotation = RotateFlipType.Rotate270FlipX Or m_Rotation = RotateFlipType.Rotate270FlipX Or m_Rotation = RotateFlipType.Rotate90FlipX Or m_Rotation = RotateFlipType.Rotate270FlipNone Or m_Rotation = RotateFlipType.Rotate90FlipNone) Then
                SourceImageRatio = New Decimal(CDbl(My.Resources.Motor1_Red_Right.Height) / CDbl(My.Resources.Motor1_Red_Right.Width))
                HeightRatio = New Decimal(CSng(Width) / CSng(My.Resources.Motor1_Red_Right.Width))
                WidthRatio = New Decimal(CSng(Height) / CSng(My.Resources.Motor1_Red_Right.Height))
            Else
                SourceImageRatio = New Decimal(CDbl(My.Resources.Motor1_Red_Right.Width) / CDbl(My.Resources.Motor1_Red_Right.Height))
                HeightRatio = New Decimal(CSng(Width) / CSng(My.Resources.Motor1_Red_Right.Height))
                WidthRatio = New Decimal(CSng(Height) / CSng(My.Resources.Motor1_Red_Right.Width))
            End If
            ControlSizeRatio = Math.Min(HeightRatio, WidthRatio)
            LightImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Height), ControlSizeRatio)))
            Dim gr_dest As Graphics = Graphics.FromImage(LightImage)
            gr_dest.DrawImage(My.Resources.Motor1_Red_Right, 0.0F, 0.0F, Convert.ToSingle(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Width), ControlSizeRatio)), Convert.ToSingle(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Height), ControlSizeRatio)))
            Select Case Me.m_LightColor
                Case LightColors.Red
                    LightOffImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Height), ControlSizeRatio)))
                    LightOnImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Height), ControlSizeRatio)))
                    Exit Select
                ...
                Case LightColors.Blue
                    LightOffImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Blue_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Height), ControlSizeRatio)))
                    LightOnImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Height), ControlSizeRatio)))
                    Exit Select
                Case LightColors.Yellow
                    LightOffImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Yellow_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Height), ControlSizeRatio)))
                    LightOnImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Height), ControlSizeRatio)))
                    Exit Select
                Case LightColors.Gray
                    LightOffImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Gray_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Height), ControlSizeRatio)))
                    LightOnImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Height), ControlSizeRatio)))
                    Exit Select
                Case Else
                    LightOffImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Red_Right.Height), ControlSizeRatio)))
                    LightOnImage = New Bitmap(Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Width), ControlSizeRatio)), Convert.ToInt32(Decimal.Multiply(New Decimal(My.Resources.Motor1_Green_Right.Height), ControlSizeRatio)))
                    Exit Select
            End Select
            ...
            Select Case Me.m_LightColor
                Case LightColors.Red
                    gr_dest.DrawImage(My.Resources.Motor1_Red_Right, 0, 0, LightOffImage.Width, LightOffImage.Height)
                    gr_dest2.DrawImage(My.Resources.Motor1_Green_Right, 0, 0, LightOnImage.Width, LightOnImage.Height)
                    Exit Select
                Case LightColors.Green
                    ...
                    Exit Select
                Case LightColors.Blue
                    gr_dest.DrawImage(My.Resources.Motor1_Blue_Right, 0, 0, LightOffImage.Width, LightOffImage.Height)
                    gr_dest2.DrawImage(My.Resources.Motor1_Green_Right, 0, 0, LightOnImage.Width, LightOnImage.Height)
                    Exit Select
                Case LightColors.Yellow
                    gr_dest.DrawImage(My.Resources.Motor1_Yellow_Right, 0, 0, LightOffImage.Width, LightOffImage.Height)
                    gr_dest2.DrawImage(My.Resources.Motor1_Green_Right, 0, 0, LightOnImage.Width, LightOnImage.Height)
                    Exit Select
                Case LightColors.Gray
                    gr_dest.DrawImage(My.Resources.Motor1_Gray_Right, 0, 0, LightOffImage.Width, LightOffImage.Height)
                    gr_dest2.DrawImage(My.Resources.Motor1_Green_Right, 0, 0, LightOnImage.Width, LightOnImage.Height)
                    Exit Select
                Case Else
                    gr_dest.DrawImage(My.Resources.Motor1_Gray_Right, 0, 0, LightOffImage.Width, LightOffImage.Height)
